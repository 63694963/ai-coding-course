...
- [ ] **Step 1: Keep only the beginner framing**
...
- [ ] **Step 2: Delete the duplicate notification split**
...
- [ ] **Step 1: Keep the three Prompt components**
...
- [ ] **Step 2: Preserve the complete Prompt Lab**
...
- [ ] **Step 1: Keep beginner Context only**
...
- [ ] **Step 2: Append the advanced blocks to the existing appendix**
...
- [ ] **Step 1: Replace the separate Bridge page**

Change `#bridge` into the merged page `#path` with the single workflow: `选一个每天重复的动作 → 说清需求 → 生成第一版 → 发现问题 → 修改成功`.

- [ ] **Step 2: Fold the useful Path examples into the merged page**
...
- [ ] **Step 3: Remove the duplicate section**
...
- [ ] **Step 1: Keep the Harness main line**
...
- [ ] **Step 2: Move or hide advanced comparison material**
...
- [ ] **Step 3: Keep the visible Harness page short**
...
- [ ] **Step 1: Keep only three visual blocks in Summary**
...
- [ ] **Step 2: Move emergency scripts to appendix**
...
- [ ] **Step 3: Make the summary visually one-page**
